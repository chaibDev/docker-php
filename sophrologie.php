...
<body>
    ...
    <br>
    <h2>Ajouter une séance pour un patient existant</h2>
    <br>
    <form class="formulaire" action="" method="post">
        Nom du Patient : <input type="number" name="patient_id"><br>
        Date : <input type="date" name="date"><br>
        Notes : <input type="text" name="notes"><br>
        <input type="submit" name="ajouter_seance" value="Ajouter">
    </form>
    <br>
    <h2>Afficher les informations d'un patient</h2>
    <br>
    <form class="formulaire" action="" method="post">
